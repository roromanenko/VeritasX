...
export const BotsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * 
         * @param {string} id 
         * @param {UpdateBotRequest} [updateBotRequest] 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        apiBotsIdPut: async (id: string, updateBotRequest?: UpdateBotRequest, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            assertParamExists('apiBotsIdPut', 'id', id)
            const localVarPath = `/api/Bots/{id}`
                .replace(`{${"id"}}`, encodeURIComponent(String(id)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(updateBotRequest, localVarRequestOptions, configuration)
...
export const BotsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async apiBotsIdPut(id: string, updateBotRequest?: UpdateBotRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<BotDtoApiResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.apiBotsIdPut(id, updateBotRequest, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['BotsApi.apiBotsIdPut']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
...
export const BotsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        apiBotsIdPut(id: string, updateBotRequest?: UpdateBotRequest, options?: RawAxiosRequestConfig): AxiosPromise<BotDtoApiResponse> {
            return localVarFp.apiBotsIdPut(id, updateBotRequest, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {string} id 
...
export class BotsApi extends BaseAPI {
     ...
     * @memberof BotsApi
     */
    public apiBotsIdPut(id: string, updateBotRequest?: UpdateBotRequest, options?: RawAxiosRequestConfig) {
        return BotsApiFp(this.configuration).apiBotsIdPut(id, updateBotRequest, options).then((request) => request(this.axios, this.basePath));
    }
