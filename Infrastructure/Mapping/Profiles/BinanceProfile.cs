...
public class BinanceProfile : Profile
{
	public BinanceProfile()
	{
		...
		CreateMap<BinancePlacedOrder, Order>()
			...
			.ForMember(dest => dest.Side, opt => opt.MapFrom(src => BinanceHelpers.ToDomainSide(src.Side)))
			.ForMember(dest => dest.Type, opt => opt.MapFrom(src => BinanceHelpers.ToDomainOrderType(src.Type)))
			...
			.ForMember(dest => dest.Status, opt => opt.MapFrom(src => BinanceHelpers.ToDomainStatus(src.Status)))
